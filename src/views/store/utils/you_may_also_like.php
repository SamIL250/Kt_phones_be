            ...
            <div class="p-4 flex flex-col group transition-all duration-300">
                    ...
                    <div class="mt-4 flex flex-col items-center">
                        ...
                        <div class="flex items-center justify-center gap-1 mb-1">
                            <span class="text-lg font-bold text-blue-400"><?php echo $product['discount_price'] ? ' Frw ' . number_format($product['discount_price']) : '$' . number_format($product['base_price']); ?></span>
                            <?php for ($i = 1; $i <= 5; $i++): ?>
